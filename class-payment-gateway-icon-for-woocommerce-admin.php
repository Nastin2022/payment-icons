 ...
 * @subpackage Payment_Gateway_Icon_For_WooCommerce/admin
 */
...
class Payment_Gateway_Icon_For_WooCommerce_Admin {
    ...
    public function add_icon_form_field($id, $form_fields) {
        $form_fields['pgifw_icon'] = array(
            'title'       => __( 'Icon', 'payment-gateway-icon-for-woocommerce' ),
            'type'        => 'text',
            'description' => __( 'Enter an image URL to change the icon.', 'payment-gateway-icon-for-woocommerce' ),
            'desc_tip'    => true,
            'default'     => '',
        );
        $form_fields['pgifw_icon_2x'] = array(
            'title'       => __( 'Icon @2x', 'payment-gateway-icon-for-woocommerce' ),
            'type'        => 'text',
            'description' => __( 'Enter a @2x image URL for retina screens.', 'payment-gateway-icon-for-woocommerce' ),
            'desc_tip'    => true,
            'default'     => '',
        );
