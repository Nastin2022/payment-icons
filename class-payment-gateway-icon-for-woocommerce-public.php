...
class Payment_Gateway_Icon_For_WooCommerce_Public {
    ...
    public function modify_icon($icon = '', $id = '') {
        ...
        $custom_icon        = $payment_gateway->get_option('pgifw_icon');
        $custom_icon_2x     = $payment_gateway->get_option('pgifw_icon_2x');
		...
		$img_style="margin-left: 0.3em; max-height: 28px; max-width: 65px;"
        
        return "<img src=\"$img_src\" alt=\"$img_alt\" $img_srcset\"$img_style"/>";
    }
